        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="lg:w-2/3">
            <div className="bg-surface rounded-3xl shadow-sm border border-accent-gold/20 overflow-hidden">
              {cartItems.map((item) => (
                <div key={item._id} className="flex flex-col sm:flex-row items-center justify-between p-6 border-b border-accent-gold/20 last:border-b-0 gap-4 hover:bg-transparent/50 transition-colors group">
                  
                  <div className="w-full sm:w-28 h-28 flex-shrink-0 relative overflow-hidden rounded-xl border border-accent-gold/20">
                  ...
                  <div className="flex-grow min-w-0 px-2 sm:px-4">
                    ...
                    <div className="inline-flex items-center">
                      <select 
                        ...
                        className="bg-transparent border border-accent-gold/20 text-text-primary rounded-lg px-3 py-1 text-sm font-medium focus:ring-2 focus:ring-accent-gold outline-none cursor-pointer hover:bg-surface transition-colors"
                      >
                  ...
                  <button 
                    ...
                    className="p-3 text-red-500 bg-red-50 hover:bg-red-500 hover:text-white rounded-xl transition-colors shadow-sm sm:ml-4 flex-shrink-0"
          ...
          <div className="lg:w-1/3">
            <div className="bg-transparent rounded-3xl p-8 border border-accent-gold/20 shadow-sm sticky top-8">
              ...
              <button 
                ...
                className="w-full bg-accent-gold hover:bg-accent-gold-hover text-white text-lg font-bold py-4 rounded-xl shadow-md transition-all hover:shadow-lg disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
              >
