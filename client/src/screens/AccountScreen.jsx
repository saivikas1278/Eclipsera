              ...
              <>
                ...
                <div className="block md:hidden animate-fade-in space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <Link to="/orderlist" className="bg-surface p-4 rounded-xl border border-accent-gold/10 flex flex-col items-center justify-center gap-2 hover:border-accent-gold/30 transition-colors shadow-sm">
