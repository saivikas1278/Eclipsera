    ...
    <div className="min-h-screen bg-transparent flex flex-col font-sans text-text-primary selection:bg-accent-gold/20 selection:text-accent-gold overflow-x-hidden max-w-[100vw]">
      ...
      {!isAuthPage && (
        <a 
          ...
          className="fixed bottom-[140px] md:bottom-6 right-4 md:right-6 z-[60] bg-[#25D366] hover:bg-[#128C7E] text-white p-3 rounded-full shadow-lg transition-transform hover:scale-110 flex items-center justify-center animate-fade-in"
