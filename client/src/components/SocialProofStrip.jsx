const SocialProofStrip = () => {
  // Using the same placeholder for all 4 just for visual layout purposes
  const feedImages = [
    '/images/hero_banner.png',
    '/images/occasion_birthday.png',
    '/images/maker_profile.png',
    '/images/hero_banner.png',
  ];
    ...
    <section className="mb-0 overflow-hidden">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-1">
        {feedImages.map((src, idx) => (
          <div key={idx} className="relative group overflow-hidden aspect-square">
            <img 
              src={src} 
              alt={`Instagram feed ${idx}`} 
