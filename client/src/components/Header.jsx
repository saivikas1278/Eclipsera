        ...
        <div className="container mx-auto px-4 max-w-7xl">
          ...
          <div className="flex items-center justify-between gap-4 md:gap-8">
            ...
            <div className="flex items-center gap-4">
              ...
              <button
                className="hidden text-text-primary hover:text-accent-gold min-h-[44px] min-w-[44px] items-center justify-center"
            ...
            <div className="flex items-center space-x-6 flex-shrink-0">
              ...
              <div className="hidden lg:block relative">
                {userInfo ? (
                  <div
                    ...
                    className="py-2"
                  >
                    <button aria-label="Account menu" aria-expanded={isAccountMenuOpen} className="text-text-primary hover:text-accent-gold transition-colors flex items-center justify-center min-h-[44px] min-w-[44px]">
              ...
              <button
                ...
                className="lg:hidden text-text-primary hover:text-accent-gold transition-colors relative flex items-center justify-center min-h-[44px] min-w-[44px]"
              >
                <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" /></svg>
              </button>

              {/* Wishlist */}
              <Link to="/wishlist" aria-label="Wishlist" className="hidden lg:flex text-text-primary hover:text-accent-gold transition-colors relative items-center justify-center min-h-[44px] min-w-[44px]">
              ...
              <button
                ...
                className="text-text-primary hover:text-accent-gold transition-colors relative flex items-center justify-center min-h-[44px] min-w-[44px]"
              >
