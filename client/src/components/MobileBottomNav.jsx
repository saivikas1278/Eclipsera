  ...
  return (
    <div className="md:hidden fixed bottom-0 left-0 right-0 bg-surface/95 backdrop-blur-md border-t border-accent-gold/20 shadow-[0_-5px_20px_rgba(0,0,0,0.1)] z-40 pb-safe">
      <nav className="flex justify-around items-center h-16">
        ...
        <Link 
          to="/wishlist" 
          className={`flex flex-col items-center justify-center w-full h-full min-w-12 min-h-12 relative ${isActive('/wishlist') ? 'text-accent-gold' : 'text-text-secondary hover:text-text-primary'}`}
        >
