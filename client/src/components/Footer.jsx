        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12 mb-8 md:mb-16">
          ...
          <div className="col-span-1 md:col-span-2 lg:col-span-1">
            ...
            <div className="flex space-x-4 text-accent-gold">
              ...
              <a href="https://www.instagram.com/eclipsera_premium?igsh=MTVhMmZqdzI0dmZqZw==&igsi=MTVhMmZqdzI0dmZqZw==" target="_blank" rel="noopener noreferrer" className="hover:text-accent-gold-hover transition-colors">
