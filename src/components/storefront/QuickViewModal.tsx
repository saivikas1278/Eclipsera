...
export const QuickViewModal: React.FC<QuickViewModalProps> = ({ product, onClose }) => {
  const { addToCart, openProductDetail, isInWishlist, toggleWishlist } = useStore();
  ...
  return (
    <div className="fixed inset-0 z-50 bg-obsidian-900/70 backdrop-blur-sm flex items-center justify-center p-4 animate-fade-in overflow-y-auto">
      <div className="bg-cream-100 w-full max-w-full sm:max-w-4xl rounded-2xl shadow-2xl overflow-hidden border border-gold-500/30 relative max-h-[90vh] flex flex-col md:flex-row box-border">
