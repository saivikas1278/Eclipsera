...
export const ProductCard: React.FC<ProductCardProps> = ({ product, onQuickView }) => {
  const { openProductDetail, addToCart, isInWishlist, toggleWishlist } = useStore();
  ...
  return (
    <div 
      className="group relative bg-white rounded-2xl overflow-hidden border border-cream-300 shadow-sm hover:shadow-luxury transition-all duration-300 flex flex-col justify-between h-full"
      ...
      <div className="p-2.5 sm:p-3.5 flex-1 flex flex-col justify-between space-y-1.5">
        ...
        <div>
          ...
          <div className="flex items-center gap-1 mt-1">
            ...
            <span className="text-[10px] text-obsidian-900 font-bold">{product.rating}</span>
