  ...
  return (
    <div className="fixed inset-0 z-50 overflow-hidden bg-obsidian-900/60 backdrop-blur-sm animate-fade-in max-w-full">
      ...
      <div className="fixed inset-y-0 right-0 max-w-full flex">
        <div className="w-full max-w-full sm:max-w-md bg-cream-100 shadow-2xl flex flex-col border-l border-gold-500/30 overflow-x-hidden box-border">
          ...
          {cart.length > 0 && (
            <div className="p-4 bg-cream-200 border-t border-cream-300 space-y-3 shrink-0 w-full box-border">
              ...
              <div className="space-y-1.5 text-xs text-obsidian-900 font-medium border-t border-cream-300 pt-2.5 w-full">
