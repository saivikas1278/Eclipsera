...
export const OrderConfirmationView: React.FC = () => {
  const { lastPlacedOrder, setCurrentView } = useUser();
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8 sm:py-12 space-y-8 sm:space-y-10 animate-fade-in">
      ...
      <div className="bg-obsidian-900 text-cream-100 rounded-3xl p-6 sm:p-12 text-center space-y-4 border border-gold-500/40 relative overflow-hidden shadow-2xl">
        ...
        <div className="pt-2 flex flex-wrap justify-center gap-3">
          <button 
            ...
            className="bg-gold-500 text-obsidian-900 hover:bg-gold-400 font-bold text-[10px] tracking-wider uppercase px-4 py-2.5 rounded-xl transition-all flex items-center gap-1.5 shadow-sm"
          >
          ...
          <button 
            ...
            className="bg-obsidian-800 text-cream-100 hover:text-gold-400 border border-gold-500/40 font-semibold text-[10px] tracking-wider uppercase px-4 py-2.5 rounded-xl transition-all flex items-center gap-1.5"
          >
          ...
          <button 
            ...
            className="bg-white text-obsidian-900 hover:bg-cream-200 border border-cream-300 font-bold text-[10px] tracking-wider uppercase px-4 py-2.5 rounded-xl transition-all flex items-center gap-1.5"
          >
