...
export const ArtisanStoriesView: React.FC = () => {
  ...
  const guildStories = [
    ...
    {
      id: 'g-3',
      title: 'Devika Devi & Jaipur Pottery Guild',
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 space-y-10 sm:space-y-16 pb-28 md:pb-12 animate-fade-in">
          ...
          <div key={guild.id} className="bg-white rounded-3xl overflow-hidden border border-cream-300 shadow-md flex flex-col justify-between">
            ...
            <div className="p-6 sm:p-8 space-y-3">
              ...
              <button 
                ...
                className="px-4 py-2.5 bg-obsidian-900 text-cream-100 rounded-xl font-bold text-xs uppercase tracking-wider hover:bg-gold-600 hover:text-obsidian-900 flex items-center gap-2 transition-all shadow-sm"
              >
...
export default ArtisanStoriesView;
