...
export const AdminDashboardView: React.FC = () => {
  ...
  const [activeTab, setActiveTab] = useState<'dashboard' | 'products' | 'orders' | 'categories' | 'users'>('dashboard');
  ...
  useEffect(() => {
    // SSE Real-time Alerts Listener for Orders
    try {
