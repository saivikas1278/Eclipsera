...
export const HomeView: React.FC = () => {
  const { products, categories, setCurrentView } = useStore();
  ...
  const craftCollections = [
    ...
    },
    {
      ...
      slug: 'brass-keychains',
      count: products.filter(p => p.category === 'brass-keychains').length,
      image: 'https://images.unsplash.com/photo-1615397349754-cfa2066a298e?auto=format&fit=crop&w=600&q=80',
      region: 'Varanasi Artisans'
    },
    {
      id: 'col-3',
    ...
    },
    {
      ...
      count: products.filter(p => p.category === 'custom-woodcraft').length,
  ...
  return (
    <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 py-4 sm:py-8 space-y-8 sm:space-y-12 pb-28 md:pb-12">
