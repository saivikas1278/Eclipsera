...
export const TrackOrderView: React.FC = () => {
  const { orders, addToCart, products, setCurrentView } = useStore();
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-8 space-y-10 pb-28 md:pb-12">
      ...
      {hasSearched && (
        searchedOrder ? (
          <div className="bg-cream-100 p-6 rounded-3xl border border-cream-300 space-y-4 shadow-md animate-fade-in">
      ...
      <div className="space-y-6">
        ...
        {orders.length === 0 ? (
          ...
          orders.map(order => {
            ...
            return (
              <div key={order.id} className="bg-white rounded-3xl p-6 sm:p-8 border border-cream-300 shadow-sm space-y-6">
                ...
                <div className="space-y-2">
                  <span className="text-[11px] font-bold text-obsidian-900 uppercase">Live Delivery Timeline</span>
